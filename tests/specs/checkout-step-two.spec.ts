...
const checkoutStepTwoTests = (userType: UseType) => {
  test.describe(`Checkout Step Two Tests - ${userType} user`, () => {
    ...
    test(
      "should display order summary elements",
    ...
    test(
      "should display correct items in summary",
    ...
    test(
      "should complete order when finish button clicked",
      { tag: [EXECUTION_TAGS.critical] },
      async ({ page }) => {
    ...
    test(
      "should persist items after page reload",
